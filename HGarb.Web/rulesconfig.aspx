                ...
                <div class="tab-content">
                    ...
                    <div id="generic" class="tab-pane">
                        ...
                        <div class="row form-group">
                            <label class="control-label col-lg-2" for="listTemplates">IsAutoElementName</label>
                            <div class="col-lg-10">
                                <asp:CheckBox runat="server" ID="generic_chkboxIsAutoElementName" AutoPostBack="true" OnCheckedChanged="cbIsAutoElemName_CheckedChanged" />
                            </div>
                        </div>
                        <div class="row form-group">
                            <label class="control-label col-lg-2" for="listTemplates">Element Name</label>
                        ...
                        <div class="row form-group">
                            <div class="col-lg-4">
                                <label class="control-label" for="lbDEFields">Standard Field Name</label>
                                <asp:ListBox runat="server" ID="generic_stdFieldName" ClientIDMode="Static" Height="200" BorderColor="Gray" BorderWidth="1" BorderStyle="Solid" Width="100%" ondblclick="addDeField()"></asp:ListBox>
                            </div>
                            <div class="col-lg-4">
                                <label class="control-label" for="lbOperator">Operator</label>
                                <asp:ListBox runat="server" ID="generic_lstboxOperator" ClientIDMode="Static" Height="200" BorderColor="Gray" BorderWidth="1" BorderStyle="Solid" Width="100%" ondblclick="addOpField()">
                                    <asp:ListItem Text="+" Value="PLUS" />
                                    <asp:ListItem Text="-" Value="MINUS" />
                                    <asp:ListItem Text="*" Value="MULTIPLY" />
                                    <asp:ListItem Text="/" Value="DIVIDE" />
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-lg-2">
                                <label class="control-label" for="cbPreviousYear">IsPreviousYear</label>
                                <asp:CheckBox runat="server" ID="generic_chkboxIsPreviousYear" AutoPostBack="true" OnCheckedChanged="cbPreviousYear_CheckedChanged" />
                            </div>
                            <div class="col-lg-6">
                                <label class="control-label" for="tbRuleName">Previous Year Columns</label>
                            ...
                            <div class="col-lg-1">
                                <asp:Button ID="generic_btnAddRule" runat="server" Text="Add Rule" class="btn btn-info" OnClick="btnAddRule_Click" />
                            </div>
                        </div>
                        <div class="row form-group">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-lg-4" style="text-align: right;">
                                <asp:Button ID="generic_btnSave" runat="server" class="btn btn-info" OnClick="btnSave_Click" Text="Save Rules" />
                            </div>
                        </div>
                    </div>
                </div>
